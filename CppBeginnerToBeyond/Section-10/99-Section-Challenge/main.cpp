 ...
 * Currently the cipher only substitutes letters - you could easily add digits, puncuation, whitespace and so forth. 
...
int main() {
    ...
    string key      {"XZNLWEBGJHQDYVTKFUOMPCIASRxznlwebgjhqdyvtkfuompciasr 0357924681"};
    ...
    std::getline(cin, secret_message);
    ...
    cout << "\nDecrypted message : " << secret_message << endl;
